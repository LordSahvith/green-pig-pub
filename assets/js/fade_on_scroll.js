...
(function ($) {
  ...
  // Hide the element. Doing this here will prevent the elements from disappering if JS is disabled.
  $('.fade-right > *').css({ 'opacity': '0', 'transform': 'translateX(' + -2 + 'em)' });
  ...
  // Hide the element. Doing this here will prevent the elements from disappering if JS is disabled.
  $('.fade-up > *').css({ 'opacity': '0', 'transform': 'translateY(' + 2 + 'em)' });
  ...
  // Hide the element. Doing this here will prevent the elements from disappering if JS is disabled.
  $('.fade-up-3 > *').css({ 'opacity': '0', 'transform': 'translateY(' + 2 + 'em)' });
  ...
  // Hide the element. Doing this here will prevent the elements from disappering if JS is disabled.
  $('.fade-up-2 > *').css({ 'opacity': '0', 'transform': 'translateY(' + 2 + 'em)' });
  ...
  // Hide the element. Doing this here will prevent the elements from disappering if JS is disabled.
  $('.fade-down > *').css({ 'opacity': '0', 'transform': 'translateY(' + -2 + 'em)' });
